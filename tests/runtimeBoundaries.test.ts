...
import { migrateAndRepairProject, parseImportedProjectJson, validateProjectV7Shape } from "../src/engine/projectImport";
...
describe("runtime and document boundaries", () => {
  ...
  it("validates imported unknown JSON before preserving migration and repair", () => {
    ...
    expect(validateProjectV7Shape(result.project).version).toBe(7);
  });

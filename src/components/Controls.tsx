    ...
    <aside className="controls">
      <section className="control-section text-section">
        ...
        <div className="control-group nested-group">
          <div className="section-subheading">Safe typography</div>
          <div className="split">
          ...
          <div className="split">
            <Range label="Kerning strength" value={state.kerningStrength} min={0} max={2} step={0.05} onChange={(kerningStrength) => patch({ kerningStrength })} />
            <Range label="Vertical offset" value={state.textOffsetY} min={-120} max={120} onChange={(textOffsetY) => patch({ textOffsetY })} />
          </div>
          <label className="debug-toggle">
            <input
              ...
              onChange={(event) => patch({
                ...
                opticalSpacingStrength: event.target.checked && state.opticalSpacingStrength === 0
                  ? 0.25
                  : state.opticalSpacingStrength,
              })}
            />
            <span>Optical spacing</span>
          </label>
          <Range label="Optical strength" value={state.opticalSpacingStrength} min={0} max={1} step={0.05} onChange={(opticalSpacingStrength) => patch({ opticalSpacingStrength })} />
        </div>
